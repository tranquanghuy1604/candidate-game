...
export default function NumericalChallenge() {
  return (
    <div className="p-16">
      ...
      <div className="w-full max-w-[600px] mx-auto mt-[80px]">
        ...
        <div className="mt-[20px]">
          ...
          <ul className="list-disc mt-[20px] text-[16px] leading-[32px] font-[400] px-[40px]">
            <li>32 questions are given in 250 seconds.</li>
            <li className="my-[10px]">
              Choose a number that is close enough to the right answer.
            </li>
            <li>
          ...
          >
            <Link
              ...
              href="/candidate/assessment/numerical-challenge/test-numerical-challenge"
            >
              Start
            </Link>
          </Button>
